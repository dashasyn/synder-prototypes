...
### Filtering Options Prototype (2026-04-30; v2 functional, v3 multiselect, v4 Apply-gated, v5 six variants — all 2026-08-04; v7 variant 2026-08-07; v8 V6/V7 refinements 2026-08-11; v9 Variant 8 + v10–v12 V6 rework 2026-08-20; v13 real taxonomy 2026-08-21)
- **Status:** ✅ v13 live and verified — eight variants, all Apply-gated, on Synder's **real production taxonomy: 19 statuses in 5 groups**. 437 jsdom + 239 Chromium checks across eleven suites in `scripts/`.
...
- **Variants:**
  ...
  6. **Recommended** — My recommendation rather than another layout: status segmented control with counts **plus an ordinary status filter with all 19 statuses, grouped as the app groups them, wired to the same value**, so the two are views of one thing. Date + Platform are pinned to the bar; every chip looks alike; `Clear filters` appears only when something is applied; no count line. Reasoning notes render under the prototype.
