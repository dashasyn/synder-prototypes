...
- **On the hub** (2026-09-07): listed under a new **Campaigns** sub-group in `projects/index.html`. Checked live incl. click-through — `scripts/check-hub-banner-card.cjs`. The hub is `projects/index.html`; root `index.html` and `prototypes/index.html` are both stale and list neither this nor any recent project.
