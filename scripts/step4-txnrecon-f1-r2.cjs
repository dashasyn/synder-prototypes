/**
 * Step 4 — deterministic checks for TxnRecon Finalist 1 (round 2 flow).
...
const FILE = '/tmp/r2wt/projects/txnrecon-setup/finalist-1-sketch.html';
const KIT = '/home/ubuntu/.openclaw/workspace/ui-kit/synder-ui-kit.css';
const OUT = '/tmp/r2wt/projects/txnrecon-setup/round2/auto-findings.json';
...
(async () => {
  ...
  // round 2: nothing is preselected and the data section waits for integration + account
